...
public class ForgotPasswordTest extends TestBase{
	...
	String mobileNumFormat		= "mobileNumFormat";
	
	String mobileNumFormat_Row2		= new String (reader.getCellData(sheetName, mobileNumFormat, 2));
	String unregisteredEmail_Row2	= reader.getCellData(sheetName, unregisteredEmail, 2);
	String currentUrl_Row2			= reader.getCellData(sheetName, currentUrl, 2);
	...
	public void verify_SignInLinkClickActionTest() throws Throwable {
		...
		Assert.assertEquals(signInPage, currentUrl_Row2);
	...
	public void submit_UnregisteredEmailIdTest() throws Throwable {
		String weDontRecognizeEmail=forgotPwd.submit_UnregisteredEmailId(unregisteredEmail_Row2);
	...
	public void verifyCaptcha() throws Throwable {
		String captchaRequired = forgotPwd.verifyCaptcha(prop.getProperty("illumy_Email2"));
		Assert.assertEquals(captchaRequired, "Captcha is required");
	...
	public void submit_ValidEmailId() throws Throwable {
		...
		Assert.assertEquals(verifyMissingDigits, "For security purposes, please verify the missing digits from your mobile number");
		System.out.println(verifyMissingDigits);
	}
	
	@Test(priority=12,enabled=true)
	public void verifyMobileNumFormat() throws Throwable {
		String actualMobileNumFormat = forgotPwd.verifyMobileNumFormat(prop.getProperty("illumy_Email2"));
		Assert.assertEquals(actualMobileNumFormat, mobileNumFormat_Row2);
		System.out.println(actualMobileNumFormat);
	}
	...
	public void verifySigninLinkInMobileNumView() throws Throwable {
		String signInPage=forgotPwd.verifySigninLinkInMobileNumView(prop.getProperty("illumy_Email2"));
		Assert.assertEquals(signInPage, currentUrl_Row2);
		System.out.println(signInPage);
	}
	...
	public void changeMyPwd_WithoutAnyDataTest() throws Throwable {
		...
		for(int i = 0;i<verificaficationCodeReq.length;i++) {
			...
			System.out.println(verificaficationCodeReq[i]);
		}
	}
	...
	public void changeMyPwd_WithoutConfirmNewPwdTest() throws Throwable {
		String confirmPwdReq=forgotPwd.changeMyPwd_WithOutConfirmNewPwd(prop.getProperty("illumyEmail3"));
	...
	public void changeMyPwd_ValidResetCode_7DigitsNewPwd() throws Throwable {
		String use8CharsPwd=forgotPwd.changeMyPwd_ValidResetCode_7DigitsNewPwd(prop.getProperty("illumyEmail3"));
	...
	public void changeMyPwd_MoreThan8DigitsNewPwd() throws Throwable {
		String confirmPwdReq=forgotPwd.changeMyPwd_MoreThan8DigitsNewPwd(prop.getProperty("illumyEmail3"));
		Assert.assertEquals(confirmPwdReq, "Confirm new password is required");
	}
	...
	public void changeMyPwd_MoreThan8DigitsConfirmNewPwd() throws Throwable {
		String pwdDontMatch=forgotPwd.changeMyPwd_MoreThan8DigitsConfirmNewPwd(prop.getProperty("illumyEmail3"));
	...
	public void verify_EyeIcon_NewPwdTest() throws Throwable {
		String newPwdEyeIcon=forgotPwd.verify_EyeIcon_NewPwd(prop.getProperty("illumyEmail3"));
	...
	public void changeMyPwd_WithValidInputsTest() throws Throwable {
		...
		Assert.assertEquals(welcomeToillumy, currentUrl_Row2);
