...
public class SignUpPageTest extends TestBase{
	...
	public void signUpClickAction() {
		...
		Assert.assertEquals(signUpUrl, prop.getProperty("signUpUrl"));
	...
	public void verifyLearnMoreLinkTest() throws Throwable {
	...
	public void verifySigninLink_SignupPageTest() {
		...
		Assert.assertEquals(signUrl, prop.getProperty("signinUrl"));
	...
	public void verifyAlreadyRegisteredUser() throws Exception {
		String alreadyRegUser=signUpPage.verifyAlreadyRegisteredUser();
	...
	public void verifyCaptcha_SignUpPage() throws Exception {
		String captchaReq=signUpPage.verifyCaptcha_SignUpPage();
	...
	public void verifyMobileNum_ValidNum() throws Exception {
		Assert.assertTrue(signUpPage.verifyMobileNum_ValidNum());
	}
	...
	public void verifyYourPhoneNumberScreenUI() throws Exception {
		Assert.assertTrue(signUpPage.verifyYourPhoneNumberScreenUI());
	}
	...
	public void verifyPhoneNumber_WithOutOTP() throws Exception {
		Assert.assertTrue(signUpPage.verifyPhoneNumber_WithOutOTP());
	}
	
	//Verify the phone number with invalid OTP
	@Test(priority=48,enabled=true)
	public void verifyPhoneNumber_InvalidOTP() throws Exception {
		String captchaReq=signUpPage.verifyPhoneNumber_InvalidOTP();
	...
	public void verifyResendVerificationCode() throws Exception {
		Assert.assertTrue(signUpPage.verifyResendVerificationCode());
	}
	
	//Verify the edit number button click functionality
	@Test(priority=50,enabled=true)
	public void verifyEditNumberBtnTest() throws Exception {
		String reenterMobileNum=signUpPage.verifyEditNumberBtn();
	...
	public void verifySendBtn_EditMobileNumTest() throws Exception {
		Assert.assertTrue(signUpPage.verifySendBtn_EditMobileNum());
	}
